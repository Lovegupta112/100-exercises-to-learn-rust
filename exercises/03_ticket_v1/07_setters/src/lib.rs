...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        ...
        Ticket::is_title_empty(&title);
        Ticket::is_title_valid(&title);
        Ticket::is_desc_empty(&description);
        Ticket::is_desc_valid(&description);
    ...
    fn is_title_empty(title:&str){
          if title.is_empty() {
            panic!("Title cannot be empty");
        }
    }
    fn is_desc_empty(description:&str){
    ...
    fn is_desc_valid(description:&str){
    ...
    pub fn set_description(&mut self,desc:String){
        Ticket::is_desc_empty(&desc);
        Ticket::is_desc_valid(&desc);
